...
public class OpportunityManager {
    ...
    // CSV schema: ID,Name,Type,Link,Status,DueDate,Comments,Flagged,FlagNote,SuggestedReopenDate
    private static final String HEADER = "ID,Name,Type,Link,Status,DueDate,Comments,Flagged,FlagNote,SuggestedReopenDate";
